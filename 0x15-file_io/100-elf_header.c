#include "main.h"
/**
 * main - main entry point of the func.
 * @argc: argument count fo the program
...
/**
 * validate_elf - helpes in checking if input is valid elf file
...
/**
 * print_magic - print ELF's magic numbers
 * @e_ident: pointer to char array
 */
